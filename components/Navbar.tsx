...
const Navbar = () => {
  return (
    <nav className='fixed top-4 left-1/2 -translate-x-1/2 flex justify-between items-center p-4 w-full max-w-7xl mx-auto rounded-full border bg-white/50 backdrop-blur-sm z-50'>
